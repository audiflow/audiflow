...
|-------------|----------|-------------|
| Production | `https://audiflow.github.io/audiflow-smartplaylist/assets/v6/` | `audiflow-smartplaylist` |
| Staging | `https://audiflow.github.io/audiflow-smartplaylist/assets-stg/v6/` | `audiflow-smartplaylist` |
| Development | `https://audiflow.github.io/audiflow-smartplaylist/assets-dev/v6/` | `audiflow-smartplaylist` |
...
- Vendored schemas at `packages/audiflow_domain/test/fixtures/` (`playlist-definition.schema.json`, `pattern-index.schema.json`, `pattern-meta.schema.json`) must be kept in sync with upstream (v6 schema)
