...
void main() {
  group('SmartPlaylistPattern', () {
    test('SmartPlaylistPattern holds pattern configuration', () {
    ...
    test('SmartPlaylistPattern can have custom sort spec', () {
      final pattern = SmartPlaylistPattern(
        id: 'test',
        resolverType: 'rss',
        config: {},
      ...
      expect(pattern.customSort, isA<SimpleSmartPlaylistSort>());
    });

    test('SmartPlaylistPattern.matchesPodcast matches by '
        'GUID first', () {
      // ignore: deprecated_member_use_from_same_package
      final pattern = SmartPlaylistPattern(
        id: 'test',
    ...
    test('SmartPlaylistPattern supports feedUrlPatterns list', () {
      final pattern = SmartPlaylistPattern(
        id: 'coten_radio',
        feedUrlPatterns: [
    ...
    test('matchesPodcast matches any pattern in '
        'feedUrlPatterns with anchoring', () {
      final pattern = SmartPlaylistPattern(
        id: 'coten_radio',
    ...
    test('SmartPlaylistPattern can have episodeNumberExtractor', () {
      final pattern = SmartPlaylistPattern(
        id: 'test',
        resolverType: 'rss',
        config: {},
