...
class MockEpisodeRepository extends _i1.Mock implements _i8.EpisodeRepository {
  ...
  _i4.Future<void> upsertFromFeedItemsWithConfig(
    int? podcastId,
    List<_i9.PodcastItem>? items, {
    required _i11.PresetConfig? config,
  }) =>
      (super.noSuchMethod(
            Invocation.method(
  ...
  @override
  _i4.Future<List<_i7.Episode>> getPendingAutoDownloadByPodcastId(
    int? podcastId,
  ) =>
      (super.noSuchMethod(
...
class MockAppSettingsRepository extends _i1.Mock
  ...
  _i15.AutoPlayOrder getAutoPlayOrder() =>
      (super.noSuchMethod(
            ...
            returnValue: _i15.AutoPlayOrder.defaultOrder,
          )
  ...
  @override
  _i4.Future<void> setPrivacyConsentAccepted(bool? accepted) =>
      (super.noSuchMethod(
