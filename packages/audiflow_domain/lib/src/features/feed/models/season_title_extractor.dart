...
final class SeasonTitleExtractor {
  ...
  ///
  /// Supported values: "title", "description", "seasonNumber", "episodeNumber"
  final String source;

  /// Regex pattern to extract value (optional).
  ///
  /// When provided, the pattern is matched against the source field.
  ...
  /// Example: "Season {value}" with seasonNumber=3 produces "Season 3"
