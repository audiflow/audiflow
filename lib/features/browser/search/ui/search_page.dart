...
import 'package:audiflow/features/browser/search/ui/podcast_search_controller.dart';
            ...
            CustomScrollView(
              ...
              slivers: <Widget>[
                ...
                state.when(
                  ...
                  error: (_, __) => FillRemainingError.podcastNoResults(),
                  data: (data) => ITunesItemList(items: data.items),
                ),
              ],
            ),
            const ErrorNotifier(),
        ...
        child: Container(
          ...
          child: TextField(
            ...
            onSubmitted: (value) {
              ...
              ref.read(podcastSearchControllerProvider.notifier).input(
                    NewPodcastSearchEvent(
                      term: value,
