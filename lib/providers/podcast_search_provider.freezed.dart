...
mixin _$PodcastSearchState {
  ...
  List<Podcast> get results => throw _privateConstructorUsedError;
...
abstract class $PodcastSearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String term, List<Podcast> results, pcast.SearchResult? chartResults});
}
...
class _$PodcastSearchStateImpl implements _PodcastSearchState {
  const _$PodcastSearchStateImpl(
      {this.term = '',
      final List<Podcast> results = const [],
      this.chartResults})
      : _results = results;
