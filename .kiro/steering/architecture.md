...
### audiflow_domain
- **Type**: Dart package
- **Dependencies**: `audiflow_core`, `isar`, `dio`, etc.
...
- `audiflow_domain` depends on: `audiflow_core`
...
│   │       ├── subscription/
│   │       │   ├── models/subscription.dart               # @collection (Isar)
│   │       │   └── repositories/...
│   │       ├── feed/
│   │       │   ├── models/
│   │       │   │   ├── podcast.dart                       # @collection (Isar)
│   │       │   │   └── episode.dart                       # @collection (Isar)
│   │       │   ├── repositories/
...
│   │       ├── library/
│   │       │   ├── models/podcast_metadata.dart           # @collection (Isar)
│   │       │   └── repositories/...
│   │       ├── player/
│   │       │   ├── models/
│   │       │   │   ├── player_state.dart                  # @freezed
│   │       │   │   ├── playback_position.dart             # @collection (Isar)
...
│   │       ├── queue/
│   │       │   ├── models/queue_item.dart                 # @collection (Isar)
│   │       │   └── repositories/...
│   │       ├── download/
│   │       │   ├── models/
│   │       │   │   ├── download_task.dart                 # @collection (Isar)
...
│   │       ├── settings/
│   │       │   ├── models/app_settings.dart               # @collection (Isar)
│   │       │   └── repositories/...
│   │       └── monitoring/
...
class Podcast {
  ...
  // Use Isar's built-in types directly
  late DateTime lastFetchedAt;

  // No separate DTO - this model is used everywhere
}
```
...
| **Isar model** (@collection) | `audiflow_domain` | `lib/src/features/{feature}/models/` | `audiflow_domain/lib/src/features/feed/models/podcast.dart` |
...
- Models: `{entity}.dart` (use @collection for Isar models, @freezed for non-persisted models)

**Rule 4: Model annotations**
- Persisted data → use `@collection` (Isar)
- Transient/computed data → use `@freezed`
- Never create separate DTOs - use Isar models directly everywhere
